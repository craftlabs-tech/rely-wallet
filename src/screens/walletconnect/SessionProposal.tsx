...
function SessionProposal() {
  const route = useRoute<StackScreenProps<RootStackParamList, Paths.SessionProposal>['route']>();
  ...
  return (
    <View
      ...
      <View style={[layout.center, gutters.gap_12]}>
        ...
        <View style={[layout.row, , layout.center, layout.center, gutters.gap_4]}>
          {proposal.verifyContext.verified.validation === 'VALID' && !proposal.verifyContext.verified.isScam ? (
            <Ionicons name="checkmark-outline" size={16} color={colors.icon_04} />
          ) : (
      ...
      {proposal.verifyContext.verified.isScam && (
        <View
          ...
          <View style={[layout.row, layout.center, gutters.gap_12, layout.justifyCenter, gutters.paddingHorizontal_16]}>
      ...
      {proposal.verifyContext.verified.validation === 'INVALID' && (
        <View
          ...
          <View style={[layout.row, layout.center, gutters.gap_12, layout.justifyCenter, gutters.padding_10]}>
      ...
      <View
        ...
        <View style={[layout.row, layout.center, gutters.gap_4]}>
      ...
      <View
        ...
        <View style={[layout.row, layout.center, layout.fullWidth]}>
          <View style={[layout.row, layout.flex_1, layout.itemsCenter, gutters.gap_6]}>
      ...
      <View style={[layout.w_90, layout.row, layout.center, layout.justifyAround, gutters.gap_10]}>
